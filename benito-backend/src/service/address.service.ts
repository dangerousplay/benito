...
export class CoordenadasDoCep {
    private static busca_aproximada: boolean;
    private static precisao: number;
    private static casas_dec_dist: number;
    ...
    static async getByEndereco(endereco) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try{
                ...
                let body_dados_endereco = await this.get_https(opcoes_https);

                const dados_endereco = JSON.parse(body_dados_endereco) as any[];
    ...
    static async getByCep(cep) {
        ...
        return new Promise<any>(async (resolve, reject) => {
            ...
            try {
                ...
                let info_cep = await this.getInfoCep(cep) as any;
    ...
    static async getDistEntreCeps(cep1, cep2){
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try{
                const info_cep1 = await this.getByCep(cep1) as any;

                const info_cep2 = await this.getByCep(cep2) as any;
